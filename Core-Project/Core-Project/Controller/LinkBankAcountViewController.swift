...
func presentPlaidLink(){
    ...
    let linkConfiguration = PLKConfiguration(key: "a26bacd40a288d215735a0cfcb1508", env: .sandbox, product: .auth, selectAccount: true, longtailAuth: false, apiVersion: .PLKAPILatest)
